# Amazon OpenSearch Ingestion MCP Server

This MCP (Model Content Protocol) server provides access to Amazon OpenSearch Ingestion API functionality through HTTP, HTTPS, and STDIO transport modes.
